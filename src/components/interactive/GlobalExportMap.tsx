              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3.5">
                    ...
                    <div>
                      <h4 className="text-sm font-black text-slate-900 dark:text-white">{hub.country}</h4>
                      <p className="text-xs text-slate-500 dark:text-emerald-300/60 font-mono">{hub.city}</p>
                    </div>
                  </div>

                  <div className="text-right">
                    <span className="text-xs font-bold font-mono text-[#059669] dark:text-[#10E599] block">{hub.domain}</span>
