...
export default function NatleAIAssistant() {
 ...
 className="absolute bottom-13 sm:bottom-14 right-0 w-[92vw] sm:w-[440px] h-[520px] max-h-[75vh] rounded-3xl bg-slate-950/95 backdrop-blur-2xl border border-white/15 shadow-[0_25px_60px_rgba(0,0,0,0.6)] flex flex-col overflow-hidden mb-2"
 >
 {/* Header */}
 ...
 className="relative flex items-center justify-end rounded-full bg-[#18181b]/95 border border-white/20 shadow-[0_10px_30px_rgba(0,0,0,0.5)] backdrop-blur-xl overflow-hidden cursor-pointer group"
 >
