...
export default function HardwareScrollytelling() {
 ...
 className="relative h-[600vh] bg-transparent text-[#09131F] transition-colors duration-400 select-none font-sans"
 >
 {/* ================= ACCESSIBILITY: SKIP LINK ================= */}
 <a 
 href="#after-hardware-section" 
 className="sr-only focus:not-sr-only focus:fixed focus:top-24 focus:left-6 z-50 px-4 py-2 bg-[#059669] ] text-white rounded-full font-mono text-xs font-bold shadow-2xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white"
 >
 ...
 <span className="font-mono text-[10.5px] tracking-widest uppercase text-slate-500 ">
 ...
 {/* Vertical Track Tube */}
 <div className="relative w-[2px] h-48 sm:h-56 bg-slate-200 rounded-full">
 ...
 className="group relative flex items-center justify-center w-3 h-3 rounded-full cursor-pointer focus-visible:ring-2 focus-visible:ring-[#059669] ] focus-visible:outline-none"
 aria-label={`Jump to stage ${stage.label}`}
 >
 <span 
 className={`w-2 h-2 rounded-full transition-all duration-300 ${
 isActive
 ? "bg-[#059669] ] scale-125 shadow-[0_0_8px_#10E599]"
 : "bg-slate-300 group-hover:scale-110 group-hover:bg-[#059669]"
 }`}
 />
 {/* Floating Tooltip */}
 <span className="absolute right-6 opacity-0 group-hover:opacity-100 transition-opacity font-mono text-[9px] font-bold tracking-wider uppercase px-2 py-0.5 rounded-md bg-slate-900 text-white whitespace-nowrap shadow-md pointer-events-none">
 {stage.short}
 </span>
 </button>
 );
 ...
 <span className="font-mono text-[11px] sm:text-xs font-bold tracking-wider uppercase text-slate-900 ">
 TERRA.SENSE <span className="font-normal text-slate-500 hidden sm:inline">&bull; NATLE TELEMETRY PROBE</span>
 </span>
 </div>

 <div className="flex items-center gap-2.5 sm:gap-4">
 <span className="font-mono text-[11px] sm:text-xs font-bold tracking-widest text-slate-500 ">
 0{activeStage} / 05
 </span>
 ...
 <button
 onClick={toggleTheme}
 className="pointer-events-auto w-8 h-8 sm:w-9 sm:h-9 rounded-full border border-slate-200/80 bg-white/80 backdrop-blur-xl flex items-center justify-center text-[#059669] ] shadow-sm hover:scale-105 active:scale-95 transition-all cursor-pointer focus-visible:ring-2 focus-visible:ring-[#059669] ] focus-visible:outline-none"
 ...
 {/* STAGE 0: HERO */}
 <div 
 className={`absolute top-[22%] sm:top-[34%] left-4 right-4 sm:right-auto sm:left-14 max-w-sm transition-all duration-500 bg-white/80 backdrop-blur-xl sm:bg-transparent sm: sm:backdrop-blur-none p-5 sm:p-0 rounded-3xl sm:rounded-none border border-slate-200/80 sm:border-0 shadow-xl sm:shadow-none ${
 activeStage === 0 ? "opacity-100 translate-y-0 pointer-events-auto" : "opacity-0 translate-y-4 pointer-events-none"
 }`}
 >
 <div className="inline-flex items-center gap-2 font-mono text-[10px] font-bold tracking-[0.2em] text-[#047857] ] uppercase mb-2">
 <span className="w-1.5 h-1.5 rounded-full bg-[#059669] ] animate-pulse" />
 <span>Domain 02: Agriculture AI &bull; Edge Telemetry</span>
 </div>

 <h1 className="text-3xl sm:text-5xl lg:text-6xl font-black tracking-tight leading-[1.05] text-slate-900 mb-2">
 Built from{" "}
 ...
 <p className="text-xs sm:text-sm text-slate-600 leading-relaxed font-normal mt-2.5 max-w-xs">
 ...
 <Link
 href="/contact"
 className="gradient-btn group inline-flex items-center gap-2 rounded-full px-5 py-2.5 sm:px-6 sm:py-3 text-xs font-bold uppercase tracking-wider text-[#021A12] shadow-md hover:scale-105 active:scale-95 transition-all focus-visible:ring-2 focus-visible:ring-[#059669] ] focus-visible:outline-none"
 >
 ...
 <div className="mt-6 sm:mt-8 flex items-center gap-2.5 font-mono text-[10px] sm:text-[10.5px] tracking-[0.14em] text-slate-500 uppercase font-bold">
 <div className="w-[1px] h-6 sm:h-8 bg-gradient-to-b from-[#059669] ] to-transparent opacity-50" />
 ...
 <div className="absolute -top-10 left-1/2 -translate-x-1/2 w-72 h-36 bg-[#10E599]/15 blur-3xl rounded-full pointer-events-none" />

 <div className="relative w-full bg-white/85 backdrop-blur-xl px-6 py-4.5 rounded-3xl border border-slate-200/90 shadow-2xl )] flex flex-col items-center">
 <div className="inline-flex items-center gap-2 font-mono text-[10.5px] font-bold tracking-[0.22em] text-[#D97706] ] uppercase mb-1">
 ...
 {/* Telemetry Chips */}
 <div className="mt-3 flex items-center gap-2 font-mono text-[9px] sm:text-[9.5px] font-bold tracking-wider text-slate-600 uppercase">
 <span className="px-2.5 py-0.5 rounded-full bg-slate-100 border border-slate-200 ">3.3V Trickle</span>
 <span className="px-2.5 py-0.5 rounded-full bg-slate-100 border border-slate-200 ">Monocrystalline</span>
 </div>
 </div>
 ...
 <span className="font-mono text-[8.5px] tracking-[0.2em] text-[#059669] uppercase mt-0.5">crown focal point</span>
 </div>
 </div>

 {/* STAGE 2: SHELL */}
 <div 
 className={`absolute top-[22%] sm:top-[32%] left-4 right-4 sm:right-auto sm:left-14 max-w-xs transition-all duration-500 bg-white/85 backdrop-blur-xl sm:bg-transparent sm: sm:backdrop-blur-none p-4 sm:p-0 rounded-2xl sm:rounded-none border border-slate-200/80 sm:border-0 shadow-xl sm:shadow-none ${
 ...
 <h3 className="text-xl sm:text-3xl font-black text-slate-900 tracking-tight mb-1.5">
 silicon.seal jacket
 </h3>
 ...
 {/* STAGE 3: BODY */}
 <div 
 className={`absolute top-[24%] sm:top-[42%] left-4 right-4 sm:left-auto sm:right-16 max-w-xs text-left sm:text-right transition-all duration-500 bg-white/85 backdrop-blur-xl sm:bg-transparent sm: sm:backdrop-blur-none p-4 sm:p-0 rounded-2xl sm:rounded-none border border-slate-200/80 sm:border-0 shadow-xl sm:shadow-none ${
 ...
 <p className="text-xs sm:text-sm text-slate-600 leading-relaxed font-normal ml-auto">
 ...
 {/* STAGE 4: COLLAR */}
 <div 
 className={`absolute top-[26%] sm:top-[40%] left-4 right-4 sm:right-auto sm:left-14 max-w-xs transition-all duration-500 bg-white/85 backdrop-blur-xl sm:bg-transparent sm: sm:backdrop-blur-none p-4 sm:p-0 rounded-2xl sm:rounded-none border border-slate-200/80 sm:border-0 shadow-xl sm:shadow-none ${
 ...
 >
 <div className="inline-flex items-center gap-2 font-mono text-[10px] font-bold tracking-[0.2em] text-[#047857] ] uppercase mb-1.5 sm:flex-row-reverse">
 <span>05 &mdash; tip</span>
 </div>
 <h3 className="text-xl sm:text-3xl font-black text-slate-900 tracking-tight mb-1.5">
 capacitive.ceramic prongs
 </h3>
 <p className="text-xs sm:text-sm text-slate-600 leading-relaxed font-normal ml-auto mb-4">
 ...
 <div className="glass-card rounded-2xl sm:rounded-3xl p-4 sm:p-6 text-left shadow-2xl border border-slate-200/90 backdrop-blur-2xl pointer-events-auto">
 <div className="inline-flex items-center gap-2 font-mono text-[10px] font-bold tracking-[0.2em] text-[#047857] ] uppercase mb-1.5">
 <span className="w-1.5 h-1.5 rounded-full bg-[#059669] ] animate-pulse" />
 ...
 <p className="text-xs text-slate-600 leading-relaxed mb-3 sm:mb-4 font-normal">
 Moisture, temperature and salinity, synced over LoRaWAN to the NATLE FieldOS network.
 </p>

 <div className="space-y-1.5 sm:space-y-2 pt-2 border-t border-slate-200/70 font-mono text-xs">
 <div className="flex justify-between py-1 border-b border-slate-100 text-slate-600 ">
 <span>battery life</span>
 <b className="text-slate-900 font-bold">6 seasons</b>
 </div>
 <div className="flex justify-between py-1 border-b border-slate-100 text-slate-600 ">
 <span>range</span>
 <b className="text-slate-900 font-bold">2.1 km LoRa</b>
 </div>
 <div className="flex justify-between py-1 text-slate-600 ">
 <span>depth</span>
 <b className="text-slate-900 font-bold">4 &ndash; 12 cm</b>
 </div>
 </div>
 </div>
 </div>
