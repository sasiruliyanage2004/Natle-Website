...
export default function HorizontalEstateJourney() {
 ...
 <section 
 ref={containerRef}
 className="relative h-[380vh] bg-[#F8FAFC] ] text-slate-900 select-none transition-colors duration-300"
 >
 ...
 <div className="max-w-7xl mx-auto w-full flex items-center justify-between z-30 pt-28 sm:pt-32 pb-4 border-b border-slate-200/80 ">
 <div className="flex items-center gap-3">
 <div className="w-8 h-8 rounded-xl bg-emerald-500/15 text-[#059669] ] flex items-center justify-center font-bold">
 <Activity className="w-4 h-4" />
 </div>
 <div>
 <span className="text-[10px] font-mono font-bold uppercase tracking-widest text-[#059669] ] block">
 ...
 <span className="px-3 py-1 rounded-full bg-white/90 border border-slate-200 text-slate-900 font-bold">
 ...
 <p className="mt-4 text-xs sm:text-sm text-slate-700 leading-relaxed max-w-2xl font-normal">
 {stage.description}
 </p>
 </div>
 ...
 <div 
 key={mi} 
 className="p-3 sm:p-4 rounded-2xl bg-slate-50/80 border border-slate-200/80 text-left"
 >
 <span className="text-[10px] sm:text-[11px] font-medium text-slate-500 block mb-1">
 {m.label}
 </span>
 <span 
