...
=====================================================`;
 ...
 return (
 <section id="configurator" className="relative py-28 md:py-36 bg-transparent text-[#071326] select-none transition-colors duration-300 overflow-hidden">
 ...
 <div className="inline-flex items-center gap-2 rounded-full border border-emerald-500/30 bg-white/90 px-4 py-1.5 text-xs font-mono font-bold uppercase tracking-wider text-[#059669] ] shadow-sm backdrop-blur-md mb-4">
 ...
 <div className="mb-10">
 <p className="text-xs font-mono font-bold uppercase tracking-wider text-slate-500 mb-3 text-center">
 ...
 : "bg-white/80 text-slate-700 border border-slate-200/80 hover:border-emerald-500/50"
 }`}
 >
 ...
 <div>
 <h3 className="text-xl font-black text-[#071326] ">Architecture Parameters</h3>
 <p className="text-xs text-slate-500 font-mono">Calibrated to Industry 4.0 Sovereign Standards</p>
 </div>
 </div>
 </div>
 ...
 className="w-full rounded-2xl border border-slate-200/90 bg-white/90 ] py-3.5 px-4 text-sm text-slate-900 font-medium focus:border-[#059669] focus:outline-none"
 >
 ...
 className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-emerald-500/40 bg-emerald-500/10 hover:bg-emerald-500/20 text-[#059669] ] text-xs font-mono font-bold transition-all hover:scale-105 cursor-pointer"
 >
 ...
 <div className="lg:col-span-5 rounded-[2.5rem] bg-[#071326] ] border border-emerald-500/30 p-6 sm:p-8 text-white shadow-2xl flex flex-col justify-between relative overflow-hidden backdrop-blur-2xl group">
