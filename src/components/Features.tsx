...
export default function Features() {
  return (
    <section id="services" className="relative bg-[#F1F7F4]/40 py-28 md:py-36 border-y border-slate-200/80 select-none">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          ...
          <div className="glass-card rounded-3xl p-6 border-l-4 border-l-[#0052FF] hover:-translate-y-1.5 transition-all duration-300 group">
            <div className="flex justify-between items-start mb-6">
              <span className="text-xs font-bold font-mono text-[#071326]/60 uppercase">Substrate Moisture</span>
              <div className="w-8 h-8 rounded-xl bg-blue-50 text-[#0052FF] flex items-center justify-center">
                <Droplets className="w-4 h-4" />
              </div>
            </div>
            <div className="flex items-baseline gap-2">
              <span className="text-4xl font-black text-[#071326] font-mono">68.4</span>
              <span className="text-base font-bold text-[#071326]/60">%</span>
            </div>
          ...
          <div className="glass-card rounded-3xl p-6 border-l-4 border-l-[#059669] hover:-translate-y-1.5 transition-all duration-300 group">
            <div className="flex justify-between items-start mb-6">
              <span className="text-xs font-bold font-mono text-[#071326]/60 uppercase">Nutrient Salt EC</span>
              <div className="w-8 h-8 rounded-xl bg-emerald-50 text-[#059669] flex items-center justify-center">
                <Leaf className="w-4 h-4" />
              </div>
            </div>
            <div className="flex items-baseline gap-2">
              <span className="text-4xl font-black text-[#071326] font-mono">1.28</span>
              <span className="text-sm font-bold text-[#071326]/60 font-mono">mS/cm</span>
            </div>
          ...
          <div className="glass-card rounded-3xl p-6 border-l-4 border-l-[#F59E0B] hover:-translate-y-1.5 transition-all duration-300 group">
            <div className="flex justify-between items-start mb-6">
              <span className="text-xs font-bold font-mono text-[#071326]/60 uppercase">Yield Projection</span>
              <div className="w-8 h-8 rounded-xl bg-amber-50 text-[#F59E0B] flex items-center justify-center">
                <Activity className="w-4 h-4" />
              </div>
            </div>
            <div className="flex items-baseline gap-2">
              <span className="text-4xl font-black text-[#071326] font-mono">+28.4</span>
          ...
          <div className="glass-card rounded-3xl p-6 border-l-4 border-l-[#00D2FF] hover:-translate-y-1.5 transition-all duration-300 group">
            <div className="flex justify-between items-start mb-6">
              <span className="text-xs font-bold font-mono text-[#071326]/60 uppercase">Sensor Mesh</span>
              <div className="w-8 h-8 rounded-xl bg-cyan-50 text-[#00D2FF] flex items-center justify-center">
                <Radio className="w-4 h-4" />
              </div>
            </div>
            <div className="flex items-baseline gap-2">
              <span className="text-4xl font-black text-[#071326] font-mono">99.98</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="glass-card rounded-3xl p-8 md:p-10 flex flex-col justify-between hover:shadow-2xl transition-all">
            <div>
              ...
              <h3 className="text-2xl font-black text-[#071326] mt-1">LoRaWAN Telemetry Probes</h3>
              <p className="mt-3 text-sm text-[#071326]/75 leading-relaxed font-normal">
            ...
            <div className="mt-8 pt-6 border-t border-slate-100 flex items-center justify-between">
              <span className="text-xs font-bold text-slate-500">IP68 Submersible Enclosures</span>
          ...
          <div className="glass-card rounded-3xl p-8 md:p-10 flex flex-col justify-between hover:shadow-2xl transition-all">
            <div>
              <div className="w-12 h-12 rounded-2xl bg-emerald-50 text-[#059669] flex items-center justify-center mb-6">
              ...
              <h3 className="text-2xl font-black text-[#071326] mt-1">NATLE FieldOS™ Platform</h3>
              <p className="mt-3 text-sm text-[#071326]/75 leading-relaxed font-normal">
            ...
            <div className="mt-8 pt-6 border-t border-slate-100 flex items-center justify-between">
              <span className="text-xs font-bold text-slate-500">Sub-50ms API Latency</span>
