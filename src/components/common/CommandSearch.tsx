...
export const CommandSearch: FC = () => {
 ...
 title: "Home",
 section: "Navigation",
 icon: <Building className="h-4 w-4 text-[#059669] ]" />,
 shortcut: "H",
 path: "/",
 },
 {
 ...
 icon: <Radio className="h-4 w-4 text-[#0052FF] " />,
 ...
 animate={{ opacity: 1 }}
 exit={{ opacity: 0 }}
 className="fixed inset-0 z-50 bg-[#071326]/60 backdrop-blur-sm"
 ...
 className="group flex h-9 items-center gap-2 rounded-full border border-slate-200/80 bg-white/80 ] px-3 text-xs font-semibold text-slate-700 shadow-xs backdrop-blur-md transition-all hover:border-emerald-500/50 hover:bg-white cursor-pointer"
 >
 <Search className="h-3.5 w-3.5 text-slate-400 group-hover:text-[#059669] ]" />
 ...
 className="pointer-events-auto flex max-h-[85vh] w-full max-w-lg flex-col overflow-hidden rounded-3xl border border-white/90 bg-white/95 shadow-2xl backdrop-blur-2xl text-slate-900 "
 onClick={(e) => e.stopPropagation()}
 >
 {/* Search Input Bar */}
 <div className="flex items-center border-b border-slate-100 px-5 py-4">
 <Search className="h-5 w-5 text-[#059669] ] mr-3 shrink-0" />
 <input
 ref={inputRef}
 type="text"
 ...
 isActive
 ? "bg-emerald-500/15 text-[#059669] ] font-bold"
