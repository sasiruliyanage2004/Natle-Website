...
export function CardPattern({
  ...
  const themeClasses = {
    auto: "text-[#059669]/20 dark:text-[#10E599]/25 group-hover:text-[#059669]/35 dark:group-hover:text-[#10E599]/40",
    colored: "text-[#10E599]/30 dark:text-[#10E599]/40 group-hover:text-[#10E599]/55",
    emerald: "text-[#059669]/25 dark:text-[#10E599]/35 group-hover:text-[#10E599]/50",
    cyan: "text-[#0052FF]/25 dark:text-[#00D2FF]/35 group-hover:text-[#00D2FF]/50",
    amber: "text-[#D97706]/25 dark:text-[#FBBF24]/35 group-hover:text-[#FBBF24]/50",
    neutral: "text-slate-900/10 dark:text-[#10E599]/20 group-hover:text-slate-900/20 dark:group-hover:text-[#10E599]/35",
  };
