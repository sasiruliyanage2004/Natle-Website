          ...
          {posts.map((post, index) => (
            ...
            >
              <Link href={post.href}>
                <article
                  className={cn(
                    "relative flex min-h-[380px] flex-col justify-between rounded-[2rem] border p-7 transition-all duration-300 backdrop-blur-xl shadow-md group-hover:shadow-2xl bg-white/90 dark:bg-[#070d07]/90 border-slate-200/80 dark:border-emerald-500/20 group-hover:border-emerald-500/50"
                  )}
                >
                  {/* Upper Meta & Bookmark */}
                  <div>
